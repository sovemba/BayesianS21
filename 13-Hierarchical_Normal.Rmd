...
<p align="center">
![](/Users/OnyishiChisom/Desktop/DESKTOP STUFF/0Education ish/Columbia/Summer 2021/BAYESIAN STATISTICS STATGR5224/Lecture_notes/525_08b_Hierarchical_Normal/hierarchy.png){width=55%}
</p>


$$\text{Figure 8.3 on page 133}$$

<p>&nbsp;</p>

Looking at the figure notice that
...
Looking again at figure \@ref(fig:shrink), if there were no reorderings going on, the trend would be 
monotone i.e., you wouldn't have any jumping around. However you see some jumping around in the top right. The school with the highest $\bar y$ does not have the highest $\hat \theta$. At least two schools are higher. What schools are those? 
